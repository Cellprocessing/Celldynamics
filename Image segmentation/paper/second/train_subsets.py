...
from paper.second.datasets import *
...
def train_model(root, model_type='cellpose', cell_type=None, tissue_type=None, 
    ...
    k=0
    while nmasks==0:
        print("root, cell_type, tissue_type, platform_type:",root, cell_type, tissue_type, platform_type)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', default="F:/spyder/project/cellpose_seg/", type=str, help='folder containing data to train and test on.')
    ...
    parser.add_argument('--cell_type', default="livecell", type=str, help='livecell cell_type')
