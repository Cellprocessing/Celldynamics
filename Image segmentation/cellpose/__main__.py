...
def main():
    ...
    hardware_args.add_argument('--use_gpu',default=True, help='use gpu if torch with cuda installed')
    ...
    input_img_args.add_argument('--img_filter',
                        default="_img", type=str, help='end string for images to run on')
    ...
    model_args.add_argument('--pretrained_model', default='cyto', type=str, help='model to use for running or starting training')
    ...
    training_args.add_argument('--test_dir',
                        default='D:/3_py_project/cellpose_seg/test/', type=str, help='folder containing test data (optional)')
    ...
    # misc settings
    parser.add_argument('--verbose', default=True, help='show information about running and settings and save to log')
